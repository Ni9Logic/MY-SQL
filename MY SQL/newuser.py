        ...
        if database.fetchall():
            ...
            if self.new_user_age == "0" or len(self.new_user_age) == 0 or not self.new_user_age.isdigit():
                while self.new_user_age == "0" or len(self.new_user_age) == 0 or not self.new_user_age.isdigit():
                    self.new_user_age = input(
                        "\t\t\tEnter\u001b[1;31m Age\u001b[1;0m: ")
            ...
            print(
                "\t\t\tThere are \u001b[1;31mTwo Types\u001b[1;0m of Banking Accounts\n\t\t\t1 \u001b[1;31m-->\u001b[1;0m Savings \n\t\t\t2 \u001b[1;31m-->\u001b[1;0m Current")
            ...
            database.execute("INSERT INTO User (created, name, age, password, bankbal, account_Type) VALUES(%s, %s, %s, %s, %s, %s)", (
                self.created, self.new_user_name, self.new_user_age, self.new_user_pass, self.new_user_BankBal, self.new_user_Account_Type))
            db.commit()
