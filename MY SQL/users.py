...
class User(sp.SignInPage, nw):  # USER CLASS DONE!
    ...
    def usermenu(self):
        ...
        while end == "y":
            ...
            print("\t\t\t\u001b[1;31m1\u001b[1;0m. Check Account Details")
            # Allows admin to view) all the list
            print("\t\t\t\u001b[1;31m2\u001b[1;0m. Withdraw Amount")
            # Allows admin to view specific account's detials.
            print("\t\t\t\u001b[1;31m3\u001b[1;0m. Deposit Amount")
            # Allows admin to modify an account
            print("\t\t\t\u001b[1;31m4\u001b[1;0m. Transfer Amount")
            ...
            if self.user_choice == "0" or self.user_choice > "6" or len(self.user_choice) == 0:
                while self.user_choice == "0" or self.user_choice > "6" or len(self.user_choice) == 0:
                    ...
                    # Allows admin to delete an account
                    print(
                        "\t\t\t\u001b[1;31m1\u001b[1;0m. Check Account Details")
                    # Allows admin to view) all the list
                    print("\t\t\t\u001b[1;31m2\u001b[1;0m. Withdraw Amount")
                    # Allows admin to view specific account's detials.
                    print("\t\t\t\u001b[1;31m3\u001b[1;0m. Deposit Amount")
    ...
    def case1_Check_Account_Details():
        ...
        print(
            "\t\t\tHere is the \u001b[1;31mLIST\u001b[1;0m your \u001b[1;31maccount details\u001b[1;0m")
        print(
            "\n\t\t\tAccount ID \u001b[1;31m-->\u001b[1;0m ", display_user_Record[0][0])
        print("\t\t\tCreated \u001b[1;31m-->\u001b[1;0m ",
              display_user_Record[0][1])
        print("\t\t\tName \u001b[1;31m-->\u001b[1;0m ",
              display_user_Record[0][2])
        print(
            "\t\t\tPassword \u001b[1;31m-->\u001b[1;0m ", display_user_Record[0][4])
        print("\t\t\tAge \u001b[1;31m-->\u001b[1;0m ",
              display_user_Record[0][3])
        print(
            "\t\t\tBank Balance\u001b[1;31m-->\u001b[1;0m ", display_user_Record[0][5])
        print(
            "\t\t\tAccount Type\u001b[1;31m-->\u001b[1;0m ", display_user_Record[0][6])
    ...
    def case2_Withdraw_Amount():
        ...
        print(
            "\t\t\tYour Current Bank Balance is:\u001b[1;31m", get_bankbal_fromdb[0], "\u001b[1;0m rs/-")
        ...
        database.execute(
            update_BankBal, (new_bankbal, sp.SignInPage.user_name,))
        db.commit()
        print(
            "\t\t\tYour New Balance is:\u001b[1;31m", new_bankbal, "\u001b[1;0m")
    ...
    def case3_Deposit_amount():
        ...
        if deposit <= 0:
            while deposit <= 0:
                deposit = float(input(
                    "\t\t\tEnter the \u001b[1;31mamount\u001b[1;0m you want to \u001b[1;31mdeposit\u001b[1;0m: "))
    ...
    def case4_Transfer_amount():
        ...
        if database.fetchone():
            ...
            database.execute(update_bankbal_user2,
                             (total_bankbbal_user2, user2,))
            db.commit()
            print("\t\t\tYour New Balance after transfer_amount is: ",
                  total_bankbbal_user1)
            m.getch()
        else:
